...
| `sheet.py` | Stage 1 (fetch/validate CSV) + `read_rows()`, used by every later stage |
| `drive.py` | Stage 2 (download), per-attachment state, adopts pre-existing downloads |
